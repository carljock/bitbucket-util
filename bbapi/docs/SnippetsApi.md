...
> models::PaginatedSnippets snippets_get(role)
List snippets
...
------------- | ------------- | ------------- | ------------- | -------------
**role** | Option<**String**> | Filter down the result based on the authenticated user's role (`owner`, `contributor`, or `member`). |  |

### Return type

[**models::PaginatedSnippets**](paginated_snippets.md)
...
> models::Snippet snippets_post(snippet)
Create a snippet
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**snippet** | [**Snippet**](Snippet.md) | The new snippet object. | [required] |

### Return type

[**models::Snippet**](snippet.md)
...
**encoded_id** | **String** | The snippet id. | [required] |
...
> models::SnippetComment snippets_workspace_encoded_id_comments_comment_id_get(comment_id, encoded_id, workspace)
...
[**models::SnippetComment**](snippet_comment.md)
...
> models::SnippetComment snippets_workspace_encoded_id_comments_comment_id_put(comment_id, encoded_id, workspace, snippet_comment)
...
**encoded_id** | **String** | The snippet id. | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**snippet_comment** | [**SnippetComment**](SnippetComment.md) | The contents to update the comment to. | [required] |
...
> models::PaginatedSnippetComments snippets_workspace_encoded_id_comments_get(encoded_id, workspace)
...
[**models::PaginatedSnippetComments**](paginated_snippet_comments.md)
...
> models::SnippetComment snippets_workspace_encoded_id_comments_post(encoded_id, workspace, snippet_comment)
...
**encoded_id** | **String** | The snippet id. | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**snippet_comment** | [**SnippetComment**](SnippetComment.md) | The contents of the new comment. | [required] |
...
> models::PaginatedSnippetCommit snippets_workspace_encoded_id_commits_get(encoded_id, workspace)
...
[**models::PaginatedSnippetCommit**](paginated_snippet_commit.md)
...
> models::SnippetCommit snippets_workspace_encoded_id_commits_revision_get(encoded_id, revision, workspace)
...
------------- | ------------- | ------------- | ------------- | -------------
**encoded_id** | **String** | The snippet id. | [required] |
**revision** | **String** | The commit's SHA1. | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |

### Return type

[**models::SnippetCommit**](snippet_commit.md)
...
> models::Snippet snippets_workspace_encoded_id_get(encoded_id, workspace)
Get a snippet
...
------------- | ------------- | ------------- | ------------- | -------------
**encoded_id** | **String** | The snippet id. | [required] |
**node_id** | **String** | A commit revision (SHA1). | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
...
> models::Snippet snippets_workspace_encoded_id_node_id_get(encoded_id, node_id, workspace)
...
> models::Snippet snippets_workspace_encoded_id_node_id_put(encoded_id, node_id, workspace)
...
> models::Snippet snippets_workspace_encoded_id_put(encoded_id, workspace)
Update a snippet
...
> snippets_workspace_encoded_id_revision_diff_get(encoded_id, revision, workspace, path)
...
------------- | ------------- | ------------- | ------------- | -------------
**encoded_id** | **String** | The snippet id. | [required] |
**revision** | **String** | A revspec expression. This can simply be a commit SHA1, a ref name, or a compare expression like `staging..production`. | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**path** | Option<**String**> | When used, only one the diff of the specified file will be returned. |  |
...
> models::PaginatedAccounts snippets_workspace_encoded_id_watchers_get(encoded_id, workspace)
...
> models::PaginatedSnippets snippets_workspace_get(workspace, role)
...
> models::Snippet snippets_workspace_post(workspace, snippet)
