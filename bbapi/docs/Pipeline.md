...
**created_on** | Option<**chrono::DateTime<chrono::FixedOffset>**> | The timestamp when the pipeline was created. | [optional]
**completed_on** | Option<**chrono::DateTime<chrono::FixedOffset>**> | The timestamp when the Pipeline was completed. This is not set if the pipeline is still in progress. | [optional]
