...
> models::BranchingModel repositories_workspace_repo_slug_branching_model_get(repo_slug, workspace)
...
[**models::BranchingModel**](branching_model.md)
...
> models::BranchingModelSettings repositories_workspace_repo_slug_branching_model_settings_get(repo_slug, workspace)
...
[**models::BranchingModelSettings**](branching_model_settings.md)
...
> models::BranchingModelSettings repositories_workspace_repo_slug_branching_model_settings_put(repo_slug, workspace)
...
> models::EffectiveRepoBranchingModel repositories_workspace_repo_slug_effective_branching_model_get(repo_slug, workspace)
...
[**models::EffectiveRepoBranchingModel**](effective_repo_branching_model.md)
...
> models::ProjectBranchingModel workspaces_workspace_projects_project_key_branching_model_get(project_key, workspace)
...
[**models::ProjectBranchingModel**](project_branching_model.md)
...
> models::BranchingModelSettings workspaces_workspace_projects_project_key_branching_model_settings_get(project_key, workspace)
...
> models::BranchingModelSettings workspaces_workspace_projects_project_key_branching_model_settings_put(project_key, workspace)
