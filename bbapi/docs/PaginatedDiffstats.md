...
**pagelen** | Option<**i32**> | Current number of objects on the existing page. The default value is 500 with 5000 being the maximum allowed value. | [optional]
...
**values** | Option<[**HashSet<models::Diffstat>**](Diffstat.md)> |  | [optional]
