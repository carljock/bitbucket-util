...
**script_commands** | Option<[**Vec<models::PipelineCommand>**](PipelineCommand.md)> | The list of build commands. These commands are executed in the build container. | [optional]
