...
[**user_workspaces_workspace_permissions_repositories_get**](RepositoriesApi.md#user_workspaces_workspace_permissions_repositories_get) | **GET** /user/workspaces/{workspace}/permissions/repositories | List repository permissions in a workspace for a user



## repositories_get

> models::PaginatedRepositories repositories_get(after, role, q, sort)
...
------------- | ------------- | ------------- | ------------- | -------------
**after** | Option<**String**> | Filter the results to include only repositories created on or after this [ISO-8601](https://en.wikipedia.org/wiki/ISO_8601)  timestamp. Example: `YYYY-MM-DDTHH:mm:ss.sssZ` |  |
**role** | Option<**String**> | Filters the result based on the authenticated user's role on each repository.  * **member**: returns repositories to which the user has explicit read access * **contributor**: returns repositories to which the user has explicit write access * **admin**: returns repositories to which the user has explicit administrator access * **owner**: returns all repositories owned by the current user  |  |
**q** | Option<**String**> | Query string to narrow down the response as per [filtering and sorting](/cloud/bitbucket/rest/intro/#filtering). `role` parameter must also be specified.  |  |
...
[**models::PaginatedRepositories**](paginated_repositories.md)
...
> models::PaginatedRepositories repositories_workspace_get(workspace, role, q, sort)
...
> repositories_workspace_repo_slug_delete(repo_slug, workspace, redirect_to)
Delete a repository
...
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**redirect_to** | Option<**String**> | If a repository has been moved to a new location, use this parameter to show users a friendly message in the Bitbucket UI that the repository has moved to a new location. However, a GET to this endpoint will still return a 404.  |  |
...
> models::PaginatedFiles repositories_workspace_repo_slug_filehistory_commit_path_get(commit, path, repo_slug, workspace, renames, q, sort)
...
**repo_slug** | **String** | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`.  | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**renames** | Option<**String**> |  When `true`, Bitbucket will follow the history of the file across renames (this is the default behavior). This can be turned off by specifying `false`. |  |
**q** | Option<**String**> |  Query string to narrow down the response as per [filtering and sorting](/cloud/bitbucket/rest/intro/#filtering). |  |
...
[**models::PaginatedFiles**](paginated_files.md)
...
> models::PaginatedRepositories repositories_workspace_repo_slug_forks_get(repo_slug, workspace, role, q, sort)
...
> models::Repository repositories_workspace_repo_slug_forks_post(repo_slug, workspace, repository)
Fork a repository
...
**repo_slug** | **String** | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`.  | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**repository** | Option<[**Repository**](Repository.md)> | A repository object. This can be left blank. |  |
...
> models::Repository repositories_workspace_repo_slug_get(repo_slug, workspace)
Get a repository
...
> models::RepositoryInheritanceState repositories_workspace_repo_slug_override_settings_get(repo_slug, workspace)
...
[**models::RepositoryInheritanceState**](repository_inheritance_state.md)
...
> models::PaginatedRepositoryGroupPermissions repositories_workspace_repo_slug_permissions_config_groups_get(repo_slug, workspace)
...
[**models::PaginatedRepositoryGroupPermissions**](paginated_repository_group_permissions.md)
...
> models::RepositoryGroupPermission repositories_workspace_repo_slug_permissions_config_groups_group_slug_get(group_slug, repo_slug, workspace)
...
[**models::RepositoryGroupPermission**](repository_group_permission.md)
...
> models::RepositoryGroupPermission repositories_workspace_repo_slug_permissions_config_groups_group_slug_put(group_slug, repo_slug, workspace, bitbucket_apps_permissions_serializers_repo_permission_update_schema)
...
**repo_slug** | **String** | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`.  | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**bitbucket_apps_permissions_serializers_repo_permission_update_schema** | [**BitbucketAppsPermissionsSerializersRepoPermissionUpdateSchema**](BitbucketAppsPermissionsSerializersRepoPermissionUpdateSchema.md) | The permission to grant | [required] |
...
> models::PaginatedRepositoryUserPermissions repositories_workspace_repo_slug_permissions_config_users_get(repo_slug, workspace)
...
[**models::PaginatedRepositoryUserPermissions**](paginated_repository_user_permissions.md)
...
------------- | ------------- | ------------- | ------------- | -------------
**repo_slug** | **String** | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`.  | [required] |
**selected_user_id** | **String** | This can either be the UUID of the account, surrounded by curly-braces, for example: `{account UUID}`, OR an Atlassian Account ID.  | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
...
> models::RepositoryUserPermission repositories_workspace_repo_slug_permissions_config_users_selected_user_id_get(repo_slug, selected_user_id, workspace)
...
[**models::RepositoryUserPermission**](repository_user_permission.md)
...
> models::RepositoryUserPermission repositories_workspace_repo_slug_permissions_config_users_selected_user_id_put(repo_slug, selected_user_id, workspace, bitbucket_apps_permissions_serializers_repo_permission_update_schema)
...
> models::Repository repositories_workspace_repo_slug_post(repo_slug, workspace, repository)
Create a repository
...
**repo_slug** | **String** | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`.  | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**repository** | Option<[**Repository**](Repository.md)> | The repository that is to be created. Note that most object elements are optional. Elements \"owner\" and \"full_name\" are ignored as the URL implies them. |  |
...
> models::Repository repositories_workspace_repo_slug_put(repo_slug, workspace, repository)
Update a repository
...
**repo_slug** | **String** | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`.  | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**repository** | Option<[**Repository**](Repository.md)> | The repository that is to be updated.  Note that the elements \"owner\" and \"full_name\" are ignored since the URL implies them.  |  |
...
> models::PaginatedTreeentries repositories_workspace_repo_slug_src_commit_path_get(commit, path, repo_slug, workspace, format, q, sort, max_depth)
...
**repo_slug** | **String** | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`.  | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**format** | Option<**String**> | If 'meta' is provided, returns the (json) meta data for the contents of the file.  If 'rendered' is provided, returns the contents of a non-binary file in HTML-formatted rendered markup. The 'rendered' option only supports these filetypes: `.md`, `.markdown`, `.mkd`, `.mkdn`, `.mdown`, `.text`, `.rst`, and `.textile`. Since Git does not generally track what text encoding scheme is used, this endpoint attempts to detect the most appropriate character encoding. While usually correct, determining the character encoding can be ambiguous which in exceptional cases can lead to misinterpretation of the characters. As such, the raw element in the response object should not be treated as equivalent to the file's actual contents. |  |
**q** | Option<**String**> | Optional filter expression as per [filtering and sorting](/cloud/bitbucket/rest/intro/#filtering). |  |
**sort** | Option<**String**> | Optional sorting parameter as per [filtering and sorting](/cloud/bitbucket/rest/intro/#sorting-query-results). |  |
**max_depth** | Option<**i32**> | If provided, returns the contents of the repository and its subdirectories recursively until the specified max_depth of nested directories. When omitted, this defaults to 1. |  |

### Return type

[**models::PaginatedTreeentries**](paginated_treeentries.md)
...
> models::PaginatedTreeentries repositories_workspace_repo_slug_src_get(repo_slug, workspace, format)
...
**repo_slug** | **String** | This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: `{repository UUID}`.  | [required] |
**workspace** | **String** | This can either be the workspace ID (slug) or the workspace UUID surrounded by curly-braces, for example: `{workspace UUID}`.  | [required] |
**format** | Option<**String**> | Instead of returning the file's contents, return the (json) meta data for it. |  |
...
> repositories_workspace_repo_slug_src_post(repo_slug, workspace, message, author, parents, files, branch)
...
> models::PaginatedAccounts repositories_workspace_repo_slug_watchers_get(repo_slug, workspace)
...
[**models::PaginatedAccounts**](paginated_accounts.md)
...
> models::PaginatedRepositoryPermissions user_permissions_repositories_get(q, sort)
...
------------- | ------------- | ------------- | ------------- | -------------
**q** | Option<**String**> |  Query string to narrow down the response as per [filtering and sorting](/cloud/bitbucket/rest/intro/#filtering). |  |
**sort** | Option<**String**> |  Name of a response property sort the result by as per [filtering and sorting](/cloud/bitbucket/rest/intro/#filtering). |  |
...
## user_workspaces_workspace_permissions_repositories_get

> models::PaginatedRepositoryPermissions user_workspaces_workspace_permissions_repositories_get(workspace, q, sort)
