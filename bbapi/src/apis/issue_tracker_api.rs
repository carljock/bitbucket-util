...
#[deprecated]
pub async fn repositories_workspace_repo_slug_issues_export_post(configuration: &configuration::Configuration, repo_slug: &str, workspace: &str, export_options: Option<models::ExportOptions>) -> Result<(), Error<RepositoriesWorkspaceRepoSlugIssuesExportPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
    let p_body_export_options = export_options;
    ...
    req_builder = req_builder.json(&p_body_export_options);
...
#[deprecated]
pub async fn repositories_workspace_repo_slug_issues_issue_id_changes_post(configuration: &configuration::Configuration, issue_id: &str, repo_slug: &str, workspace: &str, issue_change: models::IssueChange) -> Result<models::IssueChange, Error<RepositoriesWorkspaceRepoSlugIssuesIssueIdChangesPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_issue_id = issue_id;
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
    let p_body_issue_change = issue_change;
    ...
    req_builder = req_builder.json(&p_body_issue_change);
...
#[deprecated]
pub async fn repositories_workspace_repo_slug_issues_issue_id_comments_comment_id_put(configuration: &configuration::Configuration, comment_id: i64, issue_id: &str, repo_slug: &str, workspace: &str, issue_comment: models::IssueComment) -> Result<models::IssueComment, Error<RepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_comment_id = comment_id;
    let p_path_issue_id = issue_id;
    let p_path_repo_slug = repo_slug;
...
#[deprecated]
pub async fn repositories_workspace_repo_slug_issues_issue_id_comments_post(configuration: &configuration::Configuration, issue_id: &str, repo_slug: &str, workspace: &str, issue_comment: models::IssueComment) -> Result<(), Error<RepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_issue_id = issue_id;
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
...
#[deprecated]
pub async fn repositories_workspace_repo_slug_issues_post(configuration: &configuration::Configuration, repo_slug: &str, workspace: &str, issue: models::Issue) -> Result<models::Issue, Error<RepositoriesWorkspaceRepoSlugIssuesPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
