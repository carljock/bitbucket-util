...
pub async fn snippets_post(configuration: &configuration::Configuration, snippet: models::Snippet) -> Result<models::Snippet, Error<SnippetsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_snippet = snippet;
    ...
    req_builder = req_builder.json(&p_body_snippet);
...
pub async fn snippets_workspace_encoded_id_comments_comment_id_put(configuration: &configuration::Configuration, comment_id: i64, encoded_id: &str, workspace: &str, snippet_comment: models::SnippetComment) -> Result<models::SnippetComment, Error<SnippetsWorkspaceEncodedIdCommentsCommentIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_comment_id = comment_id;
    let p_path_encoded_id = encoded_id;
    let p_path_workspace = workspace;
    let p_body_snippet_comment = snippet_comment;
    ...
    req_builder = req_builder.json(&p_body_snippet_comment);
...
pub async fn snippets_workspace_encoded_id_comments_post(configuration: &configuration::Configuration, encoded_id: &str, workspace: &str, snippet_comment: models::SnippetComment) -> Result<models::SnippetComment, Error<SnippetsWorkspaceEncodedIdCommentsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_encoded_id = encoded_id;
    let p_path_workspace = workspace;
    let p_body_snippet_comment = snippet_comment;
...
pub async fn snippets_workspace_post(configuration: &configuration::Configuration, workspace: &str, snippet: models::Snippet) -> Result<models::Snippet, Error<SnippetsWorkspacePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_body_snippet = snippet;
