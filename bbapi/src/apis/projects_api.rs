...
pub async fn workspaces_workspace_projects_post(configuration: &configuration::Configuration, workspace: &str, project: models::Project) -> Result<models::Project, Error<WorkspacesWorkspaceProjectsPostError>> {
...
pub async fn workspaces_workspace_projects_project_key_permissions_config_groups_group_slug_put(configuration: &configuration::Configuration, group_slug: &str, project_key: &str, workspace: &str, bitbucket_apps_permissions_serializers_project_permission_update_schema: models::BitbucketAppsPermissionsSerializersProjectPermissionUpdateSchema) -> Result<models::ProjectGroupPermission, Error<WorkspacesWorkspaceProjectsProjectKeyPermissionsConfigGroupsGroupSlugPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_group_slug = group_slug;
    let p_path_project_key = project_key;
    let p_path_workspace = workspace;
    let p_body_bitbucket_apps_permissions_serializers_project_permission_update_schema = bitbucket_apps_permissions_serializers_project_permission_update_schema;
    ...
    req_builder = req_builder.json(&p_body_bitbucket_apps_permissions_serializers_project_permission_update_schema);
...
pub async fn workspaces_workspace_projects_project_key_permissions_config_users_selected_user_id_put(configuration: &configuration::Configuration, project_key: &str, selected_user_id: &str, workspace: &str, bitbucket_apps_permissions_serializers_project_permission_update_schema: models::BitbucketAppsPermissionsSerializersProjectPermissionUpdateSchema) -> Result<models::ProjectUserPermission, Error<WorkspacesWorkspaceProjectsProjectKeyPermissionsConfigUsersSelectedUserIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_key = project_key;
    let p_path_selected_user_id = selected_user_id;
    let p_path_workspace = workspace;
...
pub async fn workspaces_workspace_projects_project_key_put(configuration: &configuration::Configuration, project_key: &str, workspace: &str, project: models::Project) -> Result<models::Project, Error<WorkspacesWorkspaceProjectsProjectKeyPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_project_key = project_key;
    let p_path_workspace = workspace;
    let p_body_project = project;
