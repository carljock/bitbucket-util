...
pub async fn repositories_workspace_repo_slug_pullrequests_post(configuration: &configuration::Configuration, repo_slug: &str, workspace: &str, pullrequest: Option<models::Pullrequest>) -> Result<models::Pullrequest, Error<RepositoriesWorkspaceRepoSlugPullrequestsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
    let p_body_pullrequest = pullrequest;
    ...
    req_builder = req_builder.json(&p_body_pullrequest);
...
pub async fn repositories_workspace_repo_slug_pullrequests_pull_request_id_comments_comment_id_put(configuration: &configuration::Configuration, comment_id: i64, pull_request_id: i32, repo_slug: &str, workspace: &str, pullrequest_comment: models::PullrequestComment) -> Result<models::PullrequestComment, Error<RepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdCommentsCommentIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_comment_id = comment_id;
    let p_path_pull_request_id = pull_request_id;
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
    let p_body_pullrequest_comment = pullrequest_comment;
    ...
    req_builder = req_builder.json(&p_body_pullrequest_comment);
...
pub async fn repositories_workspace_repo_slug_pullrequests_pull_request_id_comments_post(configuration: &configuration::Configuration, pull_request_id: i32, repo_slug: &str, workspace: &str, pullrequest_comment: models::PullrequestComment) -> Result<models::PullrequestComment, Error<RepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdCommentsPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pull_request_id = pull_request_id;
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
...
pub async fn repositories_workspace_repo_slug_pullrequests_pull_request_id_merge_post(configuration: &configuration::Configuration, pull_request_id: i32, repo_slug: &str, workspace: &str, r#async: Option<bool>, pullrequest_merge_parameters: Option<models::PullrequestMergeParameters>) -> Result<models::Pullrequest, Error<RepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergePostError>> {
    ...
    req_builder = req_builder.json(&p_body_pullrequest_merge_parameters);
...
pub async fn repositories_workspace_repo_slug_pullrequests_pull_request_id_put(configuration: &configuration::Configuration, pull_request_id: i32, repo_slug: &str, workspace: &str, pullrequest: Option<models::Pullrequest>) -> Result<models::Pullrequest, Error<RepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pull_request_id = pull_request_id;
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
...
pub async fn repositories_workspace_repo_slug_pullrequests_pull_request_id_tasks_post(configuration: &configuration::Configuration, pull_request_id: i32, repo_slug: &str, workspace: &str, pullrequest_task_create: models::PullrequestTaskCreate) -> Result<models::PullrequestCommentTask, Error<RepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdTasksPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_pull_request_id = pull_request_id;
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
    let p_body_pullrequest_task_create = pullrequest_task_create;
    ...
    req_builder = req_builder.json(&p_body_pullrequest_task_create);
...
pub async fn repositories_workspace_repo_slug_pullrequests_pull_request_id_tasks_task_id_put(configuration: &configuration::Configuration, pull_request_id: i32, repo_slug: &str, task_id: i64, workspace: &str, pullrequest_task_update: models::PullrequestTaskUpdate) -> Result<models::PullrequestCommentTask, Error<RepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdTasksTaskIdPutError>> {
    ...
    req_builder = req_builder.json(&p_body_pullrequest_task_update);
