...
/// struct for typed errors of method [`create_repository_runner`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateRepositoryRunnerError {
    Status400(models::Error),
    Status409(models::Error),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`create_workspace_runner`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateWorkspaceRunnerError {
    Status400(models::Error),
    Status409(models::Error),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`delete_workspace_runner`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteWorkspaceRunnerError {
    Status404(models::Error),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`get_workspace_runner`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetWorkspaceRunnerError {
    Status404(models::Error),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_workspace_runners`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetWorkspaceRunnersError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`update_repository_runner`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateRepositoryRunnerError {
    Status404(models::Error),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`update_workspace_runner`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateWorkspaceRunnerError {
    Status404(models::Error),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_deployment_variable(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, environment_uuid: &str, deployment_variable: models::DeploymentVariable) -> Result<models::DeploymentVariable, Error<CreateDeploymentVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_path_environment_uuid = environment_uuid;
    let p_body_deployment_variable = deployment_variable;
    ...
    req_builder = req_builder.json(&p_body_deployment_variable);
...
pub async fn create_pipeline_for_repository(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, pipeline: models::Pipeline) -> Result<models::Pipeline, Error<CreatePipelineForRepositoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_body_pipeline = pipeline;
    ...
    req_builder = req_builder.json(&p_body_pipeline);
...
#[deprecated]
pub async fn create_pipeline_variable_for_team(configuration: &configuration::Configuration, username: &str, pipeline_variable: Option<models::PipelineVariable>) -> Result<models::PipelineVariable, Error<CreatePipelineVariableForTeamError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_username = username;
    let p_body_pipeline_variable = pipeline_variable;
    ...
    req_builder = req_builder.json(&p_body_pipeline_variable);
...
#[deprecated]
pub async fn create_pipeline_variable_for_user(configuration: &configuration::Configuration, selected_user: &str, pipeline_variable: Option<models::PipelineVariable>) -> Result<models::PipelineVariable, Error<CreatePipelineVariableForUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn create_pipeline_variable_for_workspace(configuration: &configuration::Configuration, workspace: &str, pipeline_variable: Option<models::PipelineVariable>) -> Result<models::PipelineVariable, Error<CreatePipelineVariableForWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_body_pipeline_variable = pipeline_variable;
...
pub async fn create_repository_pipeline_known_host(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, pipeline_known_host: models::PipelineKnownHost) -> Result<models::PipelineKnownHost, Error<CreateRepositoryPipelineKnownHostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_body_pipeline_known_host = pipeline_known_host;
    ...
    req_builder = req_builder.json(&p_body_pipeline_known_host);
...
pub async fn create_repository_pipeline_schedule(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, pipeline_schedule_post_request_body: models::PipelineSchedulePostRequestBody) -> Result<models::PipelineSchedule, Error<CreateRepositoryPipelineScheduleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_body_pipeline_schedule_post_request_body = pipeline_schedule_post_request_body;
    ...
    req_builder = req_builder.json(&p_body_pipeline_schedule_post_request_body);
...
pub async fn create_repository_pipeline_variable(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, pipeline_variable: models::PipelineVariable) -> Result<models::PipelineVariable, Error<CreateRepositoryPipelineVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_body_pipeline_variable = pipeline_variable;
...
pub async fn create_repository_runner(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str) -> Result<models::PipelineRunner, Error<CreateRepositoryRunnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;

    let uri_str = format!("{}/repositories/{workspace}/{repo_slug}/pipelines-config/runners", configuration.base_path, workspace=crate::apis::urlencode(p_path_workspace), repo_slug=crate::apis::urlencode(p_path_repo_slug));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PipelineRunner`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PipelineRunner`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateRepositoryRunnerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Create workspace runner.
pub async fn create_workspace_runner(configuration: &configuration::Configuration, workspace: &str) -> Result<models::PipelineRunner, Error<CreateWorkspaceRunnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;

    let uri_str = format!("{}/workspaces/{workspace}/pipelines-config/runners", configuration.base_path, workspace=crate::apis::urlencode(p_path_workspace));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateWorkspaceRunnerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn delete_repository_runner(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, runner_uuid: &str) -> Result<(), Error<DeleteRepositoryRunnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_path_runner_uuid = runner_uuid;

    let uri_str = format!("{}/repositories/{workspace}/{repo_slug}/pipelines-config/runners/{runner_uuid}", configuration.base_path, workspace=crate::apis::urlencode(p_path_workspace), repo_slug=crate::apis::urlencode(p_path_repo_slug), runner_uuid=crate::apis::urlencode(p_path_runner_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn delete_workspace_runner(configuration: &configuration::Configuration, workspace: &str, runner_uuid: &str) -> Result<(), Error<DeleteWorkspaceRunnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_runner_uuid = runner_uuid;

    let uri_str = format!("{}/workspaces/{workspace}/pipelines-config/runners/{runner_uuid}", configuration.base_path, workspace=crate::apis::urlencode(p_path_workspace), runner_uuid=crate::apis::urlencode(p_path_runner_uuid));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteWorkspaceRunnerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_pipelines_for_repository(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, creator_uuid: Option<&str>, target_ref_type: Option<&str>, target_ref_name: Option<&str>, target_branch: Option<&str>, target_commit_hash: Option<&str>, target_selector_pattern: Option<&str>, target_selector_type: Option<&str>, created_on: Option<String>, trigger_type: Option<&str>, status: Option<&str>, sort: Option<&str>, page: Option<i32>, pagelen: Option<i32>) -> Result<models::PaginatedPipelines, Error<GetPipelinesForRepositoryError>> {
    ...
    if let Some(ref param_value) = p_query_target_ref_type {
        req_builder = req_builder.query(&[("target.ref_type", &param_value.to_string())]);
    }
    ...
    if let Some(ref param_value) = p_query_target_selector_type {
        req_builder = req_builder.query(&[("target.selector.type", &param_value.to_string())]);
    }
...
pub async fn get_repository_runner(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, runner_uuid: &str) -> Result<models::PipelineRunner, Error<GetRepositoryRunnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_path_runner_uuid = runner_uuid;
...
pub async fn get_repository_runners(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str) -> Result<models::PaginatedPipelineRunners, Error<GetRepositoryRunnersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::PaginatedPipelineRunners`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::PaginatedPipelineRunners`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_workspace_runner(configuration: &configuration::Configuration, workspace: &str, runner_uuid: &str) -> Result<models::PipelineRunner, Error<GetWorkspaceRunnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_runner_uuid = runner_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetWorkspaceRunnerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Retrieve workspace runners.
pub async fn get_workspace_runners(configuration: &configuration::Configuration, workspace: &str) -> Result<models::PaginatedPipelineRunners, Error<GetWorkspaceRunnersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetWorkspaceRunnersError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn update_deployment_variable(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, environment_uuid: &str, variable_uuid: &str, deployment_variable: models::DeploymentVariable) -> Result<models::DeploymentVariable, Error<UpdateDeploymentVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_path_environment_uuid = environment_uuid;
...
#[deprecated]
pub async fn update_pipeline_variable_for_team(configuration: &configuration::Configuration, username: &str, variable_uuid: &str, pipeline_variable: models::PipelineVariable) -> Result<models::PipelineVariable, Error<UpdatePipelineVariableForTeamError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_username = username;
    let p_path_variable_uuid = variable_uuid;
    let p_body_pipeline_variable = pipeline_variable;
...
#[deprecated]
pub async fn update_pipeline_variable_for_user(configuration: &configuration::Configuration, selected_user: &str, variable_uuid: &str, pipeline_variable: models::PipelineVariable) -> Result<models::PipelineVariable, Error<UpdatePipelineVariableForUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_selected_user = selected_user;
    let p_path_variable_uuid = variable_uuid;
    let p_body_pipeline_variable = pipeline_variable;
...
pub async fn update_pipeline_variable_for_workspace(configuration: &configuration::Configuration, workspace: &str, variable_uuid: &str, pipeline_variable: models::PipelineVariable) -> Result<models::PipelineVariable, Error<UpdatePipelineVariableForWorkspaceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_variable_uuid = variable_uuid;
    let p_body_pipeline_variable = pipeline_variable;
...
pub async fn update_repository_build_number(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, pipeline_build_number: models::PipelineBuildNumber) -> Result<models::PipelineBuildNumber, Error<UpdateRepositoryBuildNumberError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_body_pipeline_build_number = pipeline_build_number;
    ...
    req_builder = req_builder.json(&p_body_pipeline_build_number);
...
pub async fn update_repository_pipeline_config(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, pipelines_config: models::PipelinesConfig) -> Result<models::PipelinesConfig, Error<UpdateRepositoryPipelineConfigError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_body_pipelines_config = pipelines_config;
    ...
    req_builder = req_builder.json(&p_body_pipelines_config);
...
pub async fn update_repository_pipeline_key_pair(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, pipeline_ssh_key_pair: models::PipelineSshKeyPair) -> Result<models::PipelineSshKeyPair, Error<UpdateRepositoryPipelineKeyPairError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_body_pipeline_ssh_key_pair = pipeline_ssh_key_pair;
    ...
    req_builder = req_builder.json(&p_body_pipeline_ssh_key_pair);
...
pub async fn update_repository_pipeline_known_host(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, known_host_uuid: &str, pipeline_known_host: models::PipelineKnownHost) -> Result<models::PipelineKnownHost, Error<UpdateRepositoryPipelineKnownHostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_path_known_host_uuid = known_host_uuid;
...
/// Update a schedule.
pub async fn update_repository_pipeline_schedule(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, schedule_uuid: &str, pipeline_schedule_put_request_body: models::PipelineSchedulePutRequestBody) -> Result<models::PipelineSchedule, Error<UpdateRepositoryPipelineScheduleError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_path_schedule_uuid = schedule_uuid;
    let p_body_pipeline_schedule_put_request_body = pipeline_schedule_put_request_body;
    ...
    req_builder = req_builder.json(&p_body_pipeline_schedule_put_request_body);
...
pub async fn update_repository_pipeline_variable(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, variable_uuid: &str, pipeline_variable: models::PipelineVariable) -> Result<models::PipelineVariable, Error<UpdateRepositoryPipelineVariableError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_path_variable_uuid = variable_uuid;
...
pub async fn update_repository_runner(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, runner_uuid: &str) -> Result<models::PipelineRunner, Error<UpdateRepositoryRunnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_path_runner_uuid = runner_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateRepositoryRunnerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Update workspace runner.
pub async fn update_workspace_runner(configuration: &configuration::Configuration, workspace: &str, runner_uuid: &str) -> Result<models::PipelineRunner, Error<UpdateWorkspaceRunnerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_runner_uuid = runner_uuid;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UpdateWorkspaceRunnerError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
