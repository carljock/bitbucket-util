...
/// struct for typed errors of method [`user_workspaces_workspace_permissions_repositories_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UserWorkspacesWorkspacePermissionsRepositoriesGetError {
    Status400(models::Error),
    Status401(models::Error),
    Status403(models::Error),
    UnknownValue(serde_json::Value),
...
pub async fn repositories_workspace_repo_slug_forks_post(configuration: &configuration::Configuration, repo_slug: &str, workspace: &str, repository: Option<models::Repository>) -> Result<models::Repository, Error<RepositoriesWorkspaceRepoSlugForksPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
    let p_body_repository = repository;
    ...
    req_builder = req_builder.json(&p_body_repository);
...
pub async fn repositories_workspace_repo_slug_permissions_config_groups_group_slug_put(configuration: &configuration::Configuration, group_slug: &str, repo_slug: &str, workspace: &str, bitbucket_apps_permissions_serializers_repo_permission_update_schema: models::BitbucketAppsPermissionsSerializersRepoPermissionUpdateSchema) -> Result<models::RepositoryGroupPermission, Error<RepositoriesWorkspaceRepoSlugPermissionsConfigGroupsGroupSlugPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_group_slug = group_slug;
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
    let p_body_bitbucket_apps_permissions_serializers_repo_permission_update_schema = bitbucket_apps_permissions_serializers_repo_permission_update_schema;
    ...
    req_builder = req_builder.json(&p_body_bitbucket_apps_permissions_serializers_repo_permission_update_schema);
...
pub async fn repositories_workspace_repo_slug_permissions_config_users_selected_user_id_put(configuration: &configuration::Configuration, repo_slug: &str, selected_user_id: &str, workspace: &str, bitbucket_apps_permissions_serializers_repo_permission_update_schema: models::BitbucketAppsPermissionsSerializersRepoPermissionUpdateSchema) -> Result<models::RepositoryUserPermission, Error<RepositoriesWorkspaceRepoSlugPermissionsConfigUsersSelectedUserIdPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_slug = repo_slug;
    let p_path_selected_user_id = selected_user_id;
    let p_path_workspace = workspace;
...
pub async fn repositories_workspace_repo_slug_post(configuration: &configuration::Configuration, repo_slug: &str, workspace: &str, repository: Option<models::Repository>) -> Result<models::Repository, Error<RepositoriesWorkspaceRepoSlugPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
    let p_body_repository = repository;
...
pub async fn repositories_workspace_repo_slug_put(configuration: &configuration::Configuration, repo_slug: &str, workspace: &str, repository: Option<models::Repository>) -> Result<models::Repository, Error<RepositoriesWorkspaceRepoSlugPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_repo_slug = repo_slug;
    let p_path_workspace = workspace;
    let p_body_repository = repository;
...
pub async fn user_workspaces_workspace_permissions_repositories_get(configuration: &configuration::Configuration, workspace: &str, q: Option<&str>, sort: Option<&str>) -> Result<models::PaginatedRepositoryPermissions, Error<UserWorkspacesWorkspacePermissionsRepositoriesGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_query_q = q;
    let p_query_sort = sort;

    let uri_str = format!("{}/user/workspaces/{workspace}/permissions/repositories", configuration.base_path, workspace=crate::apis::urlencode(p_path_workspace));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<UserWorkspacesWorkspacePermissionsRepositoriesGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
