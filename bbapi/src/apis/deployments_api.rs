...
pub async fn create_environment(configuration: &configuration::Configuration, workspace: &str, repo_slug: &str, deployment_environment: models::DeploymentEnvironment) -> Result<models::DeploymentEnvironment, Error<CreateEnvironmentError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_workspace = workspace;
    let p_path_repo_slug = repo_slug;
    let p_body_deployment_environment = deployment_environment;
    ...
    req_builder = req_builder.json(&p_body_deployment_environment);
