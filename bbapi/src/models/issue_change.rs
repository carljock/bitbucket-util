...
pub struct IssueChange {
    ...
    pub links: Option<Box<models::IssueChangeLinks>>,
    ...
    pub changes: Option<Box<models::IssueChangeChanges>>,
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<Box<models::TaskContent>>,
}

impl IssueChange {
    /// An issue change.
    pub fn new(r#type: String) -> IssueChange {
        IssueChange {
            r#type,
            links: None,
            name: None,
