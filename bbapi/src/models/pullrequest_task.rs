...
pub struct PullrequestTask {
    ...
    pub content: Box<models::TaskContent>,
...
impl PullrequestTask {
    pub fn new(created_on: chrono::DateTime<chrono::FixedOffset>, updated_on: chrono::DateTime<chrono::FixedOffset>, state: State, content: models::TaskContent, creator: models::Account) -> PullrequestTask {
        PullrequestTask {
            id: None,
            created_on,
            updated_on,
