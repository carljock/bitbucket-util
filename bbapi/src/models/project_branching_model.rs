...
pub struct ProjectBranchingModel {
    #[serde(rename = "type")]
    pub r#type: String,
    ...
    pub development: Option<Box<models::ProjectBranchingModelDevelopment>>,
    #[serde(rename = "production", skip_serializing_if = "Option::is_none")]
    pub production: Option<Box<models::ProjectBranchingModelDevelopment>>,
}

impl ProjectBranchingModel {
    pub fn new(r#type: String) -> ProjectBranchingModel {
